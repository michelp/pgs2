...
static void
context_callback_S2CellUnion_free(void*);

static Size
S2CellUnion_get_flat_size(ExpandedObjectHeader *eohptr);

static void
S2CellUnion_flatten_into(ExpandedObjectHeader *eohptr,
                    void *result, Size allocated_size);

static const ExpandedObjectMethods S2CellUnion_methods = {
     S2CellUnion_get_flat_size,
     S2CellUnion_flatten_into
    };

Datum
expand_flat_S2CellUnion(pgs2_FlatS2CellUnion *flat,
                   MemoryContext parentcontext);

pgs2_S2CellUnion *
construct_empty_expanded_S2CellUnion(uint64_t nvals, MemoryContext parentcontext);

pgs2_S2CellUnion *
DatumGetS2CellUnion(Datum d);

pgs2_FlatS2CellUnion *
construct_empty_flat_S2CellUnion();
...
#define PGS2_S2CELLUNION_DATA(a) ((uint64_t *)(((char *) (a)) + PGS2_S2CELLUNION_OVERHEAD()))
