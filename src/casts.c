Datum S2Point_as_S2Cell(PG_FUNCTION_ARGS) {
  pgs2_S2Point *point;
  pgs2_S2Cell *cell;
...
Datum S2Point_as_S2LatLng(PG_FUNCTION_ARGS) {
  pgs2_S2Point *point;
  pgs2_S2LatLng *ll;
...
Datum S2Cell_as_S2Point(PG_FUNCTION_ARGS) {
  pgs2_S2Cell *cell;
  pgs2_S2Point *point;
...
Datum S2Cell_as_S2LatLng(PG_FUNCTION_ARGS) {
  pgs2_S2Cell *cell;
  pgs2_S2LatLng *ll;
...
Datum S2LatLng_as_S2Point(PG_FUNCTION_ARGS) {
  pgs2_S2LatLng *ll;
  pgs2_S2Point *point;
...
Datum S2LatLng_as_S2Cell(PG_FUNCTION_ARGS) {
  pgs2_S2LatLng *ll;
  pgs2_S2Cell *cell;
